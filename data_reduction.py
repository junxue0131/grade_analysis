...
grades = pd.read_csv('C:/Users/Xue/Desktop/ing/第二学期成绩分析/sqlResult_2492158.csv')
courses = pd.read_csv('C:/Users/Xue/Desktop/ing/第二学期成绩分析/course.csv')
...
f = open(path + 'id_college_map.json', 'r')
map = f.read()
f.close()
...
grades.to_csv('C:/Users/Xue/Desktop/ing/第二学期成绩分析/final_grade_table.csv')
